...
import { _sdkStore, _store_chainId, _store_getConnectedChainFheKey, _store_initialize, } from "./store.js";
...
import { FheUType } from "../types/types.js";
import { isEncryptableItem, } from "../types/encryptable.js";
import { ResultErr, ResultOk } from "../types/result.js";
/**
...
async function encrypt(item) {
    ...
    if (!state.coFhe.enabled)
        return ResultErr("coFheEncrypt :: fhenixsdk not initialized to interact with CoFHE. Set `isCoFHE: true` in `fhenixsdk.initialize`.");
