...
const sealed_1 = require("../../types/sealed");
class PermitV2 {
    ...
    unseal(item) {
        // SealedItem
        const sealedItem = (0, sealed_1.getAsSealedItem)(item);
        if (sealedItem != null) {
