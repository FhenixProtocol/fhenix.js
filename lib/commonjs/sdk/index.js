...
class FhenixClient extends FhenixClientBase {
    ...
    constructor(params) {
        ...
        this.fhePublicKeys[this.defaultSecurityZone] = (0, init_js_1.GetFhePublicKey)(FhenixClientBase.getFheKeyFromProvider, params.provider).catch((err) => {
...
class FhenixClientSync extends FhenixClientBase {
    ...
    static create(params) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            fhePublicKeys[defaultSecurityZone] = yield (0, init_js_1.GetFhePublicKey)(FhenixClient.getFheKeyFromProvider, params.provider).catch((err) => {
                if (ignoreErrors) {
                    return undefined;
                }
                else {
