 ...
 */
export declare const _store_fetchFheKey: (chainId: string, provider: AbstractProvider, securityZone?: number) => Promise<TfheCompactPublicKey>;
export {};
//# sourceMappingURL=sdk.store.d.ts.map