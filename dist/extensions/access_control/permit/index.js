...
exports.removePermit = exports.generatePermit = exports.getAllPermits = exports.getPermit = void 0;
...
const getPermit = (contract, provider) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    return (0, exports.generatePermit)(contract, provider);
});
...
const generatePermit = (contract, provider) => __awaiter(void 0, void 0, void 0, function* () {
    if (!provider) {
