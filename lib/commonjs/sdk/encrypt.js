...
const encrypt_bool = (value, publicKey) => {
    const encrypted = fhe_js_1.CompactFheBoolList.encrypt_with_compact_public_key([value], publicKey);
    return {
...
const encrypt_uint8 = (value, publicKey) => {
    ...
    const encrypted = fhe_js_1.CompactFheUint8List.encrypt_with_compact_public_key(uint8Array, publicKey);
    return {
        data: encrypted.serialize(),
    };
};
...
const encrypt_uint16 = (value, publicKey) => {
    ...
    const encrypted = fhe_js_1.CompactFheUint16List.encrypt_with_compact_public_key(uint16Array, publicKey);
    return {
        data: encrypted.serialize(),
    };
};
...
const encrypt_uint32 = (value, publicKey) => {
    ...
    const encrypted = fhe_js_1.CompactFheUint32List.encrypt_with_compact_public_key(uint32Array, publicKey);
    return {
        data: encrypted.serialize(),
    };
};
...
const encrypt_uint64 = (value, publicKey) => {
    ...
    const encrypted = fhe_js_1.CompactFheUint64List.encrypt_with_compact_public_key(uint32Array, publicKey);
    return {
        data: encrypted.serialize(),
    };
};
